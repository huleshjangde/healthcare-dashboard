...
export default function Bmi() {
  ...
  return (
    <div className={`bg-black/80 h-fit flex flex-col  text-white w-[50%] p-6 rounded-lg ${Mulishs.className} `} >
      <div className="mb-6 flex justify-between">
        ...
        <Select   defaultValue="last-week">
          ...
          <SelectContent className="bg-[#4A4949] text-white"  position="popper">
            <SelectItem defaultChecked value="last-week">Last Week</SelectItem>
    ...
    {/* 2nd */}
      <div className="bg-[#4A4949] h-[200px] p-4 rounded-lg mb-6 w-full ml-5">
        <div className="flex justify-between  mb-2 flex-col ">
          ...
          <div className=" flex justify-between items-center w-full my-5 text-base"> <p className="text-[22px]">{bmi}</p>     <Badge className="bg-[#D6FFDD] py-1 px-2 text-base rounded-sm" variant="secondary">Your Healthy</Badge> </div>
         
        </div>
        <div className=" w-full  h-5 flex justify-center"> <div className="h-3 w-3 border-2 border-white rounded-full bg-red-500"></div></div>
   ...
   <div className="flex justify-between mt-2"> 
    ...
    <span>40</span>
      ...
      <div className="mb-6 flex justify-between items-center">
        ...
        <p className="text-sm mb-4 text-[#CACACA] font-bold">Last checked 2 Days Ago</p>
        <p className="text-[14px] mb-4 bg-[#5E5E5E] px-2 py-1 w-fit rounded-md">Inverted Triangle Body Shape</p>
            </div>
