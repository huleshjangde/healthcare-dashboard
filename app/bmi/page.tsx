...
export default function Component() {
  ...
  return (
    <div className={`bg-black/80 text-white w-[700px] p-6 rounded-lg ${Mulishs.className} `} >
      ...
      <div className="flex  gap-5 flex-col   justify-between h-[200px]   w-[300px] text-black mb-4">
